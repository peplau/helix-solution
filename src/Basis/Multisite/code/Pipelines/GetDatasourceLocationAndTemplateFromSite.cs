...
namespace Sitecore.Basis.Multisite.Pipelines
{
    public class GetDatasourceLocationAndTemplateFromSite
    {
        ...
        public void Process(GetRenderingDatasourceArgs args)
        {
            ...
            var datasource = args.RenderingItem[Templates.RenderingOptions.FieldIds.DatasourceLocation];
        ...
        protected virtual void ResolveDatasource(GetRenderingDatasourceArgs args)
        {
            ...
            var source = args.RenderingItem[Templates.RenderingOptions.FieldIds.DatasourceLocation];
        ...
        {
            var contextItem = args.ContentDatabase.GetItem(args.ContextItemPath);
            var datasourceLocation = args.RenderingItem[Templates.RenderingOptions.FieldIds.DatasourceLocation];
