...
namespace Sitecore.Basis.Multisite.Providers
{
    public class DatasourceProvider : IDatasourceProvider
    {
        ...
        public Item[] GetDatasourceLocations(Item contextItem, string datasourceName)
        {
            ...
            var datasourceRoot = sourceSettingItem?[Templates.DatasourceConfiguration.FieldIds.DatasourceLocation];
        ...
        public Item GetDatasourceTemplate(Item contextItem, string settingName)
        {
            ...
            var templateId = settingItem?[Templates.DatasourceConfiguration.FieldIds.DatasourceTemplate];
